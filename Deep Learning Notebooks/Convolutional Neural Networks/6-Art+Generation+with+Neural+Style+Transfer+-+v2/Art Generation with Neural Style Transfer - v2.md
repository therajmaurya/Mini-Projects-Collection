...
```
    ...
    <matplotlib.image.AxesImage at 0x7f7e53942f60>
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f7e515cc940>
...
def compute_layer_style_cost(a_S, a_G):
    ...
    J_style_layer = ((1.0/(4 * (n_C**2) * ((n_H * n_W)**2))) * tf.reduce_sum(tf.square(tf.subtract(GS, GG))))
...
```
    ...
    <matplotlib.image.AxesImage at 0x7f7e514efe80>
